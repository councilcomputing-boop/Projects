...
<div style="font-family:'Segoe UI',Arial,sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:24px;">
  <div style="background:#0f1420;padding:18px 24px;border-radius:8px 8px 0 0;">
    <div style="color:white;font-size:17px;font-weight:600;">Direct Bill Reconciliation</div>
  ...
  <div style="background:white;padding:32px;border:1px solid #e8eaed;border-top:none;border-radius:0 0 8px 8px;">
    <div style="font-size:22px;font-weight:700;color:#0f1420;margin-bottom:10px;">You're invited!</div>
    <div style="font-size:15px;color:#3c4043;margin-bottom:24px;line-height:1.6;">
      Hi <strong>{username}</strong>,<br><br>
      You've been added to <strong>Direct Bill Reconciliation</strong>, the carrier statement reconciliation tool for Insurance Agency of Mid America.<br><br>
      Click the button below to set up your password and access your account.
    </div>
    <div style="text-align:center;margin-bottom:28px;">
      <a href="{invite_link}" style="display:inline-block;background:#4f8cff;color:white;padding:14px 32px;border-radius:6px;text-decoration:none;font-size:16px;font-weight:600;">Set Up My Account</a>
    </div>
    ...
    <div style="margin-top:20px;font-size:12px;color:#9aa0a6;border-top:1px solid #e8eaed;padding-top:16px;">
      ...
      <span style="color:#4f8cff;">{invite_link}</span>
    </div>
  </div>
</div>
"""
    ...
    msg['Subject'] = 'You\'ve been invited to Direct Bill Reconciliation'
    msg['From']    = f'Direct Bill Reconciliation <{SMTP_USER}>'
    msg['To']      = to_email
